"""
PHASE 1: Data Re-fetch Script (CLEAN)
...
class DataRefetcher:
        ...
        try:
            ...
            for season in ['2024', '2023', '2022']:
                try:
                    ...
                    logger.warning(f"      ⚠️  Season {season} failed: {e}")
                    self.db.rollback()
                    continue
        ...
        try:
            ...
            for match_data in matches_data:
                try:
                    ...
                    is_midweek = match_date.weekday() in [1, 2, 3]
    ...
    def run(self):
        ...
        logger.info("=" * 60)
        logger.info("🚀 PHASE 1: DATA RE-FETCH (CLEAN)")
